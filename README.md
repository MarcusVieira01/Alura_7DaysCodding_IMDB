...
* **Negrito**Dia 1: Criada classe KeyReader para que a leitura da chave de acesso à API seja feita de forma externa ao código. Dessa forma protege a chave pessoal de visualização no repositório. Em uma implementação deve-se criar o arquivo k_imdb.txr com a chave escrita na primeira linha.
