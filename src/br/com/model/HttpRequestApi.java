...
public class HttpRequestApi {
    /**
     * Métodos onde serão executadas as requisiçãões HTTP para o IMDb API e API Marvel de chave obtida da classe KeyReader, capturada resposta e retornado o body como String
     * @return Corpo da resposta HTTP
     * @throws Exception
     */
    public String requestImdb() throws Exception{
        ...
        URI uri = new URI("https://imdb-api.com/en/API/Top250Movies/" + new KeyReader().getChaveImdb());
