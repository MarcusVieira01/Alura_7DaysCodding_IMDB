...
public class GeradorHtml {
     ...
     */
    public void gerarHtmlIMDB(List<? extends Content> elementos){
    ...
    public void gerarHtmlMarvel(List<? extends Content> elementos){
        //Escrita do cabeçalho do arquivo HTML
        this.escritor.write("""
            <!DOCTYPE html>
            <html lang=\"pt-br\">
            <head>
                ...
                <title>Lista TOP Series da Marvel</title>
            </head>
            
                <body style=\"background-color: #1f4a4c\">
                    <nav class=\"navbar navbar-dark text-white text-center fs-3 fw-bolder pt-4 ps-3\" style=\"background-color: #081f21;\">
                        <p>Lista TOP Series da Marvel</p>
                    </nav>
